import { aU as ProviderError, aV as IniSectionType, aW as CONFIG_PREFIX_SEPARATOR, aX as slurpFile, aY as getConfigFilepath, aZ as parseIni, a_ as getSSOTokenFilepath, aI as fsPromises, aO as getProfileName, a$ as getSSOTokenFromFile, C as CredentialsProviderError, s as setCredentialFeature } from "../index.js";
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
  const { SSOOIDCClient } = await import("./index-Dmcwmrfi.js");
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
  const { CreateTokenCommand } = await import("./index-Dmcwmrfi.js");
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso-DiPfMRPj.js");
